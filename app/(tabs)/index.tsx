...
const styles = StyleSheet.create({
  ...
  tickerTrack: { width: 2272, height: 40, flexDirection: "row-reverse", alignItems: "center" },
  tickerGroup: { width: 1136, height: 40, flexDirection: "row-reverse", alignItems: "center" },
  tickerItem: { width: 142, height: 40, flexDirection: "row-reverse", alignItems: "center" },
