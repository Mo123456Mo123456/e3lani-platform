...
| الخدمة | السعر |
|---|---|
| إعلان 30 يومًا | 59 ر.س (شامل الضريبة عند انطباقها) |
| إعادة نشر | 10 ر.س |
...
الأسعار تُدار من الخادم عبر `PricingVersion` — لا تُثبَّت في العملاء. مبلغ النشر المدفوع يبقى **59 ر.س** مع حفظ الصافي والضريبة والإجمالي منفصلين.
