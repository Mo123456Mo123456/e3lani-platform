...
export const seedAds:Ad[]=[
 ...
 {id:"AD10002",ownerId:"seed-owner",brandId:seedBrand.id,title:"مساحتك الإعلانية تبدأ من هنا",description:"واجهة نظيفة، تواصل مباشر، وإحصاءات واضحة تساعد المعلن على معرفة أداء إعلانه.",categoryId:"services",cityId:"jeddah",media:[{id:"m2",kind:"image",uri:"asset:wordmark",localAsset:"wordmark"}],contacts:[{type:"phone",value:"+966500000000"}],status:"active",revision:1,verified:true,featured:false,sponsored:false,createdAt:"2026-07-02T08:00:00.000Z",activatedAt:"2026-07-02T09:00:00.000Z",expiresAt:"2026-08-01T09:00:00.000Z",promotions:[]}];
