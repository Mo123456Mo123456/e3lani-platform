    ...
    <main className="container stack">
      <section className="panel stack">
        ...
        <p className="muted" style={{ margin: 0 }}>
          هذه مسودة قانونية بانتظار مراجعة مستشار قانوني، وليست سياسة نهائية أو نصيحة قانونية.
          This is a legal draft pending counsel review, not a final policy or legal advice.
        </p>
      </section>
      <section className="panel stack">
