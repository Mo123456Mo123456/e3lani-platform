...
export default function PricingPage() {
  ...
  return (
    <main style={{ padding: '40px 24px', maxWidth: 860, margin: '0 auto' }}>
      ...
      <p style={{ color: '#777' }}>
        الأسعار تُدار من الخادم وإصدارات التسعير — لا تُثبَّت داخل التطبيقات. سعر النشر 59 ر.س شامل
        الضريبة عند انطباقها؛ يُحفظ الصافي والضريبة والإجمالي بشكل منفصل في الطلب/الفاتورة.
      </p>
